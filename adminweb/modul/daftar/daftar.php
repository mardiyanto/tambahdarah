...
switch($_GET[act]){
	// Tampil daftar
  default:
  echo" Pendaftaran berhasil silahkan <a href='login'>login</a> ";
  break;
  ...
  case "tambahdata":
    ...
    <form name=text_form method=POST action='$aksi?module=daftar&act=input' onsubmit='return Blank_TextField_Validator()'>
      ...
      <tr><td width=120>Pasword</td><td><input type='password' class='form-control'  name='password' placeholder='Password login'></td></tr>
		  ...
		  <input class='btn btn-danger' type=button name=batal value='Batal' onclick=\"window.location.href='?module=daftar';\"></td></tr>
          </table></form>";
     break;
