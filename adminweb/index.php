...
<html><head>
  ...
  <link href="../css/font-awesome-4.2.0/font-awesome-4.2.0/css/font-awesome.min.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="../aset/datatables/dataTables.bootstrap.css">
    <script src="../aset/datatables/jquery.dataTables.min.js"></script>
    <!-- daterange picker -->
    <link rel="stylesheet" href="../aset/select2/select2.min.css">
    <script src="../aset/select2/select2.full.min.js"></script>
    <!-- jQuery 2.1.4 -->
...
<strong><div class="cinta">Copyright © 2023 - Made with <i class="fa fa-heart pulse"></i> by <a href="#" target="_blank">admin</a></div></strong>  </footer>
