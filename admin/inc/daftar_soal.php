	...
	<div class="row">
		<div class="panel panel-default">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea   id="editor"  name="pertanyaan"  rows="2" required><?php echo $data_pilgan_id['pertanyaan']; ?></textarea>
			<script>
			CKEDITOR.replace( 'editor');
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea class="form-control" id="222" name="pilA"  rows="1" required><?php echo $data_pilgan_id['pil_a']; ?></textarea>
										<script>CKEDITOR.replace( '222',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea name="pilB"  id="123"  class="form-control" rows="1" required><?php echo $data_pilgan_id['pil_b']; ?></textarea>
							<script>CKEDITOR.replace( '123',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea name="pilC" id="editor3435" class="form-control" rows="1" required><?php echo $data_pilgan_id['pil_c']; ?></textarea>
										<script>CKEDITOR.replace( 'editor3435',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea name="pilD" id="editor4" class="form-control" rows="1" required><?php echo $data_pilgan_id['pil_d']; ?></textarea>
						<script>CKEDITOR.replace( 'editor4',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea name="pilE" id="editor5" class="form-control" rows="1" required><?php echo $data_pilgan_id['pil_e']; ?></textarea>
										<script>CKEDITOR.replace( 'editor5',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
		...
		<div class="panel panel-default">
			...
			?>
				<form method="post" enctype="multipart/form-data">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id='editorty' name="pertanyaan" class="form-control" rows="3" required><?php echo $data_essay_id['pertanyaan']; ?></textarea>
								<script>
			CKEDITOR.replace( 'editorty');
		</script>
						</div>
					</div>
