	...
	<div class="row">
		<div class="panel panel-default">
		    	...
		    	<?php $sql_jumlah_pilgan = mysqli_query($db, "SELECT * FROM tb_soal_pilgan WHERE id_tq = '$id'") or die ($db->error); ?>
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor" name="pertanyaan" class="form-control" rows="2" required></textarea>
								<script>
			CKEDITOR.replace( 'editor');
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor1" name="pilA" class="form-control" rows="1" required></textarea>
							<script>CKEDITOR.replace( 'editor1',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor2" name="pilB" class="form-control" rows="1" required></textarea>
							<script>CKEDITOR.replace( 'editor2',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor3" name="pilC" class="form-control" rows="1" required></textarea>
							<script>CKEDITOR.replace( 'editor3',{height: 80} );</script>
						</div>
					</div>
					<div class="col-md-2">
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor4" name="pilD" class="form-control" rows="1" required></textarea>
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="editor5" name="pilE" class="form-control" rows="1" required></textarea>
		...
		<div class="panel panel-default">
		    ...
		    <div class="panel-body">
		    	...
		    	$sql_jumlah_essay = mysqli_query($db, "SELECT * FROM tb_soal_essay WHERE id_tq = '$id'") or die ($db->error); ?>
					...
					<div class="col-md-10">
						<div class="form-group">
							<textarea id="esay" name="pertanyaan" class="form-control" rows="3" required></textarea>
								<script>CKEDITOR.replace( 'esay');</script>
						</div>
					</div>
