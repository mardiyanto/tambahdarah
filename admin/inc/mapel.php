...
if(@$_SESSION[admin]) {
    ...
    <?php
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Data Mata Kuliah &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Data Mata kuliah &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
                    	<?php
    ...
    if(@$_GET['action'] == '') { ?>
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Mata kuliah yang Anda Ajar &nbsp; <a href="?page=mapel&action=tambah" class="btn btn-primary btn-sm">Tambah Data</a></div>
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
    ...
    <?php
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Tambah Mata kuliah yang Anda Ajar &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
                        <div class="form-group">
                            <label>Mapel *</label>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Mata kuliah yang Anda Ajar &nbsp; <a href="?page=mapel" class="btn btn-warning btn-sm">Kembali</a></div>
                <div class="panel-body">
                    <form method="post">
	                    <?php
