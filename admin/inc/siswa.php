            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table width="100%">
                            <tr>
                                <td align="right" width="46%"><b>NIDN</b></td>
                                <td align="center">:</td>
                            ...
                            <?php if(@$_SESSION[admin]) { ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center">:</td>
                                    <td><a href="?page=siswa&action=editprofil&IDsiswa=<?php echo $data['id_siswa']; ?>" class="badge">EDIT SISWA</a>
    	                        </td>
                                </tr>
        ...
        <div class="col-md-6">
            ...
            if(@$_POST['simpan']) {
                ...
                if($nama_gambar == '') {
                    ...
                    echo '<script>window.location="?action=siswa";</script>';
                } else {
